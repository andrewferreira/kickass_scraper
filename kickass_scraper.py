...
#m = soup.find_all('a', class_ = 'icon16')
...
#elem = browser.find_element_by_class("cellMainLink")

#post_elems = browser.find_elements_by_class_name("showcase-item__subtitle")

#for name in post_elem:
#    print name.text
